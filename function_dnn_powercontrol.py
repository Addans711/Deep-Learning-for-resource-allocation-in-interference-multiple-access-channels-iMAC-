...
def train(X, Y,location, training_epochs=300, batch_size=1000, LR= 0.001, 
          n_hidden_1=200, n_hidden_2=200, n_hidden_3=200,  
          traintestsplit = 0.01, LRdecay=0,patience=10):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(training_epochs):
            ...
            MSETime[epoch, 0]= c
            val_cost = sess.run(cost, feed_dict={x: X_val, y: Y_val, input_keep_prob: 1, hidden_keep_prob: 1, is_train: False})
            MSETime[epoch, 1] = val_cost
