...
def ini_weights(n_input, n_hidden_1, n_hidden_2, n_hidden_3, n_hidden_4,n_output):
    weights = {
...
def train(X, Y,location, training_epochs=300, batch_size=1000, LR= 0.001, 
          n_hidden_1=200, n_hidden_2=200, n_hidden_3=200,n_hidden_4=200, 
    ...
    weights, biases = ini_weights(n_input, n_hidden_1, n_hidden_2, n_hidden_3, n_hidden_4,n_output)
